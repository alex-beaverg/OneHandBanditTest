...
#       behave -i .feature
#   Run only with chrome.feature file (this file):
...
Feature: The game "One Hand Bandit" with "chrome" browser

  Scenario: Open and check all pages of the game with "chrome" browser
    Given website "https://one-hand-bandit.vercel.app/" with "chrome" browser
