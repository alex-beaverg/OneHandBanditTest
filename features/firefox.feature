...
#       behave -i .feature
#   Run only with firefox.feature file (this file):
...
Feature: The game "One Hand Bandit" with "firefox" browser

  Scenario: Open and check all pages of the game with "firefox" browser
